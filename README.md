...
Speech audio is generated upstream
Files are placed in input_speech/
Reaper runs this script
Rendered outputs appear in output/
Downstream tools (e.g. ffmpeg) continue processing
